...
unsigned char Tdots[8][8][3]= {{{0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}},
 ...
 {{255,0,0}, {0,255,0}, {0,255,0}, {0,255,0}, {0,255,0}, {0,255,0}, {0,255,0}, {0,255,0}},
...
unsigned char mdots[8][8][3]= 
{{{255,255,0}, {255,255,0}, {255,255,0}, {255,255,0}, {0,255,0}, {0,255,0}, {0,255,0}, {0,255,0}},
 {{255,255,0}, {255,255,0}, {255,255,0}, {255,255,0}, {0,255,0}, {0,255,0}, {0,255,0}, {0,255,0}},
 {{255,255,0}, {255,255,0}, {255,255,0}, {255,255,0}, {0,255,0}, {0,255,0}, {0,255,0}, {0,255,0}},
 {{255,255,0}, {255,255,0}, {255,255,0}, {255,255,0}, {0,255,0}, {0,255,0}, {0,255,0}, {0,255,0}},
...
jamie add
********************************************************/
void DispShowMsColors()
{
 unsigned char Page_Write,i,j,k;
 ...
 for(j = 0;j<8;j++)
 for(k = 0;k<3;k++)
 dots[Page_Write][i][j][k] = mdots[i][j][k];
